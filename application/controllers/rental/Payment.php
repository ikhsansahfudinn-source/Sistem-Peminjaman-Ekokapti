<?php 
	class Payment extends CI_Controller{
		...
		public function update_payment($id){
			...
			$penanggung_jawab	 = $this->session->userdata('penanggung_jawab');
			$data['payment'] = $this->db->query("SELECT * FROM payment WHERE id_payment='$id' AND penanggung_jawab='$penanggung_jawab'")->result();
		...
		public function delete_payment($id){
			...
			if($data['payment']['0']->penanggung_jawab != $this->session->userdata('penanggung_jawab')){
				redirect('rental/payment');
