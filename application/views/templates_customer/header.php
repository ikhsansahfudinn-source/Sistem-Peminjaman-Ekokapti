...
<head>
    ...
    <title>PENYEWAAN - Muda-Mudi Ekokapti</title>
    ...
    <!--=== Custom Slicknav CSS ===-->
    <link href="<?php echo base_url() ?>assets/assets_shop/css/custom-slicknav.css" rel="stylesheet">
    <!--=== Magnific Popup CSS ===-->
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="<?php echo base_url() ?>assets/assets_shop/img/#" alt="JSOFT">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('customer/data_barang') ?>">Barang</a></li>
