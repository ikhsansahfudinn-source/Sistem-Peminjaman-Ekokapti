      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">PENANGGUNG JAWAB PANEL</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="<?php echo base_url('rental/dashboard') ?>"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('rental/data_barang') ?>"><i class="fas fa-box"></i> <span>Data Barang</span></a></li>
