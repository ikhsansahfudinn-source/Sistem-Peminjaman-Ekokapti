			...
			<div class="card-body">
				<form method="POST" action="<?php echo base_url('rental/transaksi/cek_pembayaran') ?>">
					<?php foreach($pembayaran as $pmb) : ?>
						...
						<a class="btn btn-sm btn-success" href="<?php echo base_url('rental/transaksi/download_pembayaran/') . $pmb->id_pinjam ?>" target="_blank"><i class="fas fa-download"></i> Download Bukti Pembayaran</a>
