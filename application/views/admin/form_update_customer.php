    ...
    <form method="POST" action="<?php echo base_url('admin/data_customer/update_customer_aksi') ?>">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="role_id">
                ...
                <option value="2" <?php if($cs->role_id == '2') echo ' selected="selected"'; ?>>Penyewa</option>
                <option value="3" <?php if($cs->role_id == '3') echo ' selected="selected"'; ?>>Penanggung Jawab</option>
            </select>
        </div>

        <div class="form-group">
            <label>Nama Penanggung Jawab (opsional)</label>
            <input type="text" name="penanggung_jawab" class="form-control"  value="<?php echo $cs->penanggung_jawab ?>">
        </div>
    	<div class="form-group">
