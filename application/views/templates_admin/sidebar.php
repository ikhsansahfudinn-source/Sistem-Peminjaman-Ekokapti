      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/dashboard") !== false) ? "active" : "" ?>"><a class="nav-link" href="<?php echo base_url('admin/dashboard') ?>"><i class="fas fa-home"></i><span>Dashboard</span></a></li>

              <li class="<?php echo (strpos(current_url(), "admin/data_barang") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_barang') ?>"><i class="fas fa-box"></i> <span>Data Barang</span></a></li>
              ...
              <li class="<?php echo (strpos(current_url(), "admin/data_customer") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_customer') ?>"><i class="fas fa-user"></i> <span>Data User</span></a></li>
